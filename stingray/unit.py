...
def GetMeshData(og_object, Global_TocManager, Global_BoneNames):
    ...
    for b in bone_info:
        for i, transform_index in enumerate(b.RealIndices):
            ...
            blender_bone_matrix = mathutils.Matrix.LocRotScale(bone_transform.pos, mathutils.Matrix([bone_transform.rot.x, bone_transform.rot.y, bone_transform.rot.z]), bone_transform.scale).inverted()
